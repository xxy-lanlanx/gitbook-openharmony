...
通信子系统统一管理设备的无线连接能力，包括 WLAN、蓝牙、NFC 与蜂窝网络。它也是[16-分布式软总线](16-fen-bu-shi-ruan-zong-xian.md) 与 [27-分布式任务调度](27-fen-bu-shi-ren-wu-diao-du.md) 的连接承载——设备发现、认证、软总线建链都依赖这里的无线能力。
...
- 设备发现后需配对建立信任，配对信息由[23-安全子系统](23-an-quan-zi-xi-tong.md) 的密钥库保护。
...
4. **分布式发现不到设备**：先确认 WLAN / 蓝牙已开启且两设备可达，再回到[27-分布式任务调度](27-fen-bu-shi-ren-wu-diao-du.md) 的设备认证流程。
