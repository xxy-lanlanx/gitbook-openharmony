...
- **与软总线的关系**：设备认证通过后，[16-分布式软总线](16-fen-bu-shi-ruan-zong-xian.md) 才能基于协商出的会话密钥建立加密传输通道，承载分布式硬件、数据、任务调度。
...
- **校验时机**：
  - 安装时：[25-包管理子系统](25-bao-guan-li-zi-xi-tong.md) 校验签名合法性，拒绝未签名或签名不符的包；
  - 升级时：[22-OTA升级子系统](22-ota-sheng-ji-zi-xi-tong.md) 校验整包与差分包签名；
