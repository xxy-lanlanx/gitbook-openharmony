...
OpenHarmony 使用 **hb 命令行**配合 **GN / Ninja** 完成源码编译与镜像生成。理解构建体系是把[05-源码结构](../../02-framework/05-yuan-ma-jie-gou.md) 变成可烧录固件的关键一步，也是定位"为什么编不出来""怎么加一个新部件"的基础。
...
- 镜像烧录到设备后，由 Bootloader 加载，进入 [10-启动流程](../../03-driver-boot/10-qi-dong-liu-cheng.md) 的内核与 init 阶段。
...
- [02-开发环境搭建篇](../../01-basic/02-kai-fa-huan-jing-da-jian-pian.md)
