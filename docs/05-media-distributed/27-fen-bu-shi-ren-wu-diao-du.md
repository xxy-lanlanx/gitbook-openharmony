...
分布式任务调度（Distributed Scheduler）建立在[16-分布式软总线](../16-fen-bu-shi-ruan-zong-xian.md)、[23-安全子系统](../../07-security/23-an-quan-zi-xi-tong.md) 设备认证、[17-分布式数据管理](../17-fen-bu-shi-shu-ju-guan-li.md) 与 [18-分布式硬件](../18-fen-bu-shi-ying-jian.md) 之上，提供**跨设备 Ability 拉起、迁移流转与协同调用**能力——这是 OpenHarmony"超级终端"体验的核心支撑。
...
在 [24-元能力Ability框架](../../08-app-framework/24-ying-yong-kuang-jia-ability.md) 的基础上，Want 中填入 `deviceId` 即可拉起对端设备的 Ability：
...
- **发现新设备**：`startDeviceDiscovery` 发现附近设备，结合[30-通信子系统](../../09-build-services/30-tong-xin-zi-xi-tong.md) 的 Wi-Fi / 蓝牙完成认证入组；
