...
**安装**（以 [23-安全子系统](../../07-security/23-an-quan-zi-xi-tong.md) 的签名校验为前提）：
...
2. **安装报权限错误**：申请的权限 APL 高于自身等级（见 [23-权限与访问控制](../../07-security/23-quan-xian-guan-li-zi-xi-tong.md)）。
...
- [33-文件与存储子系统](../../09-build-services/33-wen-jian-cun-chu-zi-xi-tong.md)
