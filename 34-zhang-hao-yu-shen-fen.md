...
帐号与用户身份子系统管理设备的系统帐号、分布式帐号同步与多用户身份。它和[23-安全子系统](23-an-quan-zi-xi-tong.md) 的设备认证、[23-权限与访问控制](23-quan-xian-guan-li-zi-xi-tong.md) 的权限上下文一起，回答了"谁在使用这台设备、能否互信协同"的问题——分布式能力是否可用，很大程度取决于帐号状态。
...
- **分布式前提**：同一帐号登录的多台设备会自动建立互信群组，这正是 [23-安全子系统](23-an-quan-zi-xi-tong.md) 设备认证与 [27-分布式任务调度](27-fen-bu-shi-ren-wu-diao-du.md) 协同的基础。
